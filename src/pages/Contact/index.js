            ...
            <main>
                <div id="page-contact-content" className="container">
                    ...
                    <div id="page-contact-data" className="contact-data">
                        ...
                        <br />
                        <p id="contact-phone">WhatsApp: <a href="https://api.whatsapp.com/send?phone=054996448912&text=Estou entrando em contato através do site, " target="_blank"> (054) 9 9644-8912</a></p>
